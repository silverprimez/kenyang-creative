...
<head>
    <title>Ai Mentor | Six Column</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <!-- navbar section -->
    <!-- banner section -->
    <section class="banner-sec about-banner pricing-banner w-100 float-left bg-light-black pb-0">
        <div class="wrapper2"> 
        <!-- plans -->
        <div class="generic-title text-center">
            <h2 class="mb-0">Six Column</h2>
        </div>
        </div>
    ...
    <div class=" blog-posts blogpage-section w-100 float-left">
        <div id="blog" class="col-xl-12">
            <div class="row wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                <div class="col-xl-2 col-lg-6 col-md-6" data-aos="fade-up" data-aos-duration="600">
                            ...
                            <div id="blogslider" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item">
                                        <img src="assets/images/standard_post_img03.jpg" alt="">
                                        <!--carousel-item-->
                                    </div>
                                    <div class="carousel-item">
                    ...
                    <div class="blog-box sixcolumn-blog float-left w-100 post-item mb-4">
                        <div class="post-item-wrap position-relative">
                            <div class="post-audio position-relative">
                                <a href="#">
                                    <img alt="" src="assets/images/standard_post_img06.jpg"> </a>
                ...
                <div class="col-xl-2 col-lg-6 col-md-6" data-aos="fade-up" data-aos-duration="600">
                    <div class="blog-box sixcolumn-blog float-left w-100 post-item mb-4">
                        <div class="post-item-wrap position-relative">
                            <div class="post-audio position-relative">
                                <a href="#">
                                    <img alt="" src="assets/images/standard_post_img03.jpg"> </a>
                                <audio class="position-absolute" controls="">
                                    <source src="horse.ogg" type="audio/ogg">
                                    <source src="assets/audio/horse.mp3" type="audio/mpeg">
                                </audio>
                ...
                <div class="col-xl-2 col-lg-6 col-md-6" data-aos="fade-up" data-aos-duration="600">
                    <div class="blog-box sixcolumn-blog float-left w-100 post-item mb-4">
                        <div class="post-item-wrap position-relative">
                            <div class="post-image">
                                <a href="#">
                                    <img alt="" src="assets/images/standard_post_img04.jpg">
                                </a>
                                <!--post-image-->
                            </div>
                            <div class="blog-text-con">
                ...
                <div class="col-xl-2 col-lg-6 col-md-6" data-aos="fade-up" data-aos-duration="600">
                    <div class="blog-box sixcolumn-blog float-left w-100 post-item mb-4">
                        <div class="post-item-wrap position-relative">
                            <div class="post-image">
                                <a href="#">
                                    <img alt="" src="assets/images/standard_post_img02.jpg"> </a>
                                <!--post-image-->
                            </div>
                            <div class="blog-text-con">
                                <ul class="list-unstyled">
