...
<head>
    <title>Ai Mentor | Two Column</title>
        ...
        <div class="container">
            <div class="row wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                <div id="blog" class="col-xl-12">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-12" data-aos="fade-up" data-aos-duration="600">
                            ...
                            <div class="blog-box twocolumn-blog float-left w-100 post-item mb-4">
                                <div class="post-item-wrap position-relative">
                                    <div class="post-audio position-relative">
                                        <a href="#"><img alt="" src="assets/images/post-featured3.jpg"></a>
