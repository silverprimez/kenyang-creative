...
<head>
    <title>Ai Mentor | One Column</title>
        ...
        <div class="container">
            <div class="row wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                <div id="blog" class="col-xl-12">
                    <div class="blog-box onecolumn-blog float-left w-100 post-item mb-4" data-aos="fade-up"
                        data-aos-duration="600">
                        <div class="post-item-wrap position-relative">
                            <div class="post-image">
                                <a href="#"><img alt="" src="assets/images/post-featured.jpg"></a>
                            </div>
                    ...
                    <div class="blog-box onecolumn-blog float-left w-100 post-item mb-4" data-aos="fade-up"
                        ...
                        <div class="post-item-wrap position-relative">
                            <div class="post-image">
                                <a href="#"><img alt="" src="assets/images/post-featured4.jpg"></a>
                            </div>
                            <div class="blog-text-con">
                                <ul class="list-unstyled">
                                    <li class="d-inline-block">
